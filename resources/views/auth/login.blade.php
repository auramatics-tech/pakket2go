                        ...
                        <div class="su_mr_10_480">
                            <div class="d-lg-flex d-md-flex d-block justify-content-around">
                                ...
                                <div class="d-flex align-items-center my-4">
                                    ...
                                    <div class="flex_align_end">
                                        <p class="su_Quick_Fast su_icons_text_adjust">{{ __('home.Safe & Secure') }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="d-lg-flex d-md-flex d-block justify-content-around">
                    ...
                    <form action="{{ route('login') }}" method="post" id="login-form">
                        ...
                        <div class="su_sign_in_form_padding">
                            <div class="su_sign_in_form">
                                <p class="su_text_Sign_In">{{ __('home.Sign In') }}</p>
                                ...
                                <div class="su_inputs_padding">
                                    <div class="form-group mt-4">
                                        <input class="su_country_dropdown" id="phone" type="tel" name="phone_number" />
                                        @error('phone_number')
                                    ...
                                    <div class="form-group mt-4">
                                        <input type="password" name="password" id="" class="su_des_textarea Password" placeholder="{{ __('home.Password') }}">
                                        @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
