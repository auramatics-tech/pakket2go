<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="{{ asset('assets/svg/Pakket2go.svg') }}" class="h-25px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo1/dist/pages/profile/projects.html">
                                ...
                                <span class="menu-title">Courier Users</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo1/dist/pages/profile/campaigns.html">
                                ...
                                <span class="menu-title">Private Users</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo1/dist/pages/profile/documents.html">
                                ...
                                <span class="menu-title">Business Users</span>
                            </a>
                        </div>
                        <div class="menu-item">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Orders Managment</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                        ...
                        @if (count($booking_status))
                            @foreach ($booking_status as $status)
                                <div class="menu-item">
                                    <a class="menu-link"
                                        href="{{ route('admin.orders', ['status' => $status->status_type]) }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ $status->status }}</span>
                                    </a>
                                </div>
                            @endforeach
                        @endif
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Payments Managment</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="../../demo1/dist/index.html">
                        ...
                        <span class="menu-title">Inquiry's</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="../../demo1/dist/index.html">
