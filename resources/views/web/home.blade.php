...
@section('content')
    <section class="banner-section">
        ...
        <div class="images">
            ...
            <img src="{{ asset('assets/img/building.png') }}" class="img-fluid d-none d-lg-block d-md-block"
                alt="building">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 ps-lg-5 text-center text-md-center text-lg-start mt-md-5">
                    ...
                    <div>
                        <a href="{{ route('booking', ['step' => 'address']) }}"
                            class="book border rounded-3">{{ __('home.Book a Transport') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center flxDirection">
                <div class="col-md-6">
                    <div class="play_content">
                        ...
                        <div
                            class="d-flex align-items-center justify-content-lg-start justify-content-md-start justify-content-sm-center">
                            <a href="https://apps.apple.com/nl/app/pakket2go/id1606859161" class="appstore_btn"
                                target="_blank">
                                <div>
                                    <figure>
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.slimpakket.user&hl=nl&gl=US"
                                class="appstore_btn2 ms-lg-5 ms-3" target="_blank">
                                <div>
                                    <figure>
